...
class Command(BaseCommand):
    ...
    help = "manage.py setup_investment_declaration_medical --commit"
    ...
    def handle(self, *args: Any, **options: Any) -> Optional[str]:
        ...
        form_types = {
            ...
            # 160: "NABARD Bonds",
            200: "Medical Insurance Premium - Self/Spouse/Children 80D  25,000",
            210: "Medical Insurance Premium - Parents 80D    25,000",
            220: "Medical Insurance Premium - Parents - Sr. Citizen----- 50,000",
        ...
        qs = ChoiceType.objects.filter(
            slug="investment_declaration_medical",
        ...
        if qs.exists():
            ...
            choice_type = ChoiceType(
                slug="investment_declaration_medical",
                name="Investment Declaration Medical",
                content_type=ContentType.objects.get_for_model(DeclarationForms),
